...
package com.caseystella.ingest;
...
public final class SparseVectorsFromSequenceFiles extends AbstractJob {
  ...
  public int run(String[] args) throws Exception {
    ...
    Option analyzerNameOpt = obuilder.withLongName("analyzerName").withArgument(
     ...
     Option libJarsOpt = obuilder.withLongName("libjars").withArgument(
      abuilder.withName("libjars").withMinimum(1).withMaximum(1).create()).withDescription(
      "The default arg for libjars").withShortName("libjars").create();
    ...
    Group group = gbuilder.withName("Options").withOption(minSupportOpt).withOption(analyzerNameOpt).withOption(libJarsOpt)
